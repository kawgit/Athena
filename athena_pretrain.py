...
argparser.add_argument("--name", type=str, required=False)
...
pretrainer = Pretrainer(athena, optimizer, scaler, autocast_ctx, batch_size=args.batch_size, backwards_every=args.backwards_every, log_every=args.log_every, save_every=args.save_every, valid_every=args.valid_every)
